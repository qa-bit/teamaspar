...
class ModalityAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('nameEN')
            ->add('description', 'ckeditor', ['required' => false])
            ->add('descriptionEN', 'ckeditor', ['required' => false])
            ->add('active')
            ->add('_order')
            ->end()
            ->end()
            ...
            ->tab('Info')
                ->with(null)
                ->add('infoEs', CKEditorType::class, ['required' => false ])
                ->add('infoEn', CKEditorType::class, ['required' => false ])
                ->add('showInfo', CheckboxType::class, ['required' => false ])
            ->end()
            ->end()
            ->tab('SEO')
            ->with(null)
